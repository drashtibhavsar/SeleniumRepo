...
public class ImplicitWaitTest {
	...
	public static void main(String[] args) {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);	// implicit wait is generic and if element available then it will perform an action and go to other line 
